...
custom_html = f"""
<!-- Lettertypen worden lokaal ingebed door lokaal_maken.py -->
...
# Externe libraries en Google Fonts vervangen door lokale, ingebedde versies
from lokaal_maken import lokaal_maken
lokaal_maken(output)
